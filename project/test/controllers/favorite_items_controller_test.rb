...
class FavoriteItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite_item" do
    assert_difference("FavoriteItem.count") do
      post favorite_items_url, params: { favorite_item: { good_id: @favorite_item.good_id, user_id: @favorite_item.user_id } }
    end
  ...
  test "should update favorite_item" do
    patch favorite_item_url(@favorite_item), params: { favorite_item: { good_id: @favorite_item.good_id, user_id: @favorite_item.user_id } }
